package JavaAdvanced.src.examPreparation.hotel;

public class Main {
    public static void main(String[] args) {

        //Initialize the repository (JavaAdvanced.src.examPreparation.hotel)
        ...
        // The people in the JavaAdvanced.src.examPreparation.hotel Hilton are:
        // Person Mark: 11111, Age: 41, Hometown: Sofia
