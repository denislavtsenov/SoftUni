...
public class Main {
    public static void main(String[] args) {
        ...
        Parking parking = new Parking("Underground JavaAdvanced.src.examPreparation.parking garage", 5);
...
// The cars are parked in Underground JavaAdvanced.src.examPreparation.parking garage:
// Peugeot 307 (2011)
// Audi S4 (2005)
